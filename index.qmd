...
[![](images/funders/cinar-logo.png){alt="Cooperative Institute for the North Atlantic Region (CINAR)"}]{.funder-card href="https://www.cinar.org/" target="_blank"}

[![](images/funders/cafa-logo.png){alt="Climate and Fisheries Adaptation (CAFA) Program"}]{.funder-card href="https://cpo.noaa.gov/cafa/" target="_blank"}

[![](images/funders/nefmc-logo.png){alt="New England Fishery Management Council (NEFMC)"}]{.funder-card href="https://www.nefmc.org/" target="_blank"}

[![](images/funders/mafmc-logo.png){alt="Mid-Atlantic Fishery Management Council (MAFMC)"}]{.funder-card href="https://www.mafmc.org/" target="_blank"}

[![](images/funders/noaa-logo.png){alt="NOAA Fisheries"}]{.funder-card href="https://www.fisheries.noaa.gov/" target="_blank"}

[![](images/funders/btrp-logo.png){alt="Bycatch Reduction Engineering Program (BREP/BTRP)"}]{.funder-card href="https://www.fisheries.noaa.gov/grant/bycatch-reduction-engineering-program" target="_blank"}
